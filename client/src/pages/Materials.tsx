...
export default function Materials() {
  ...
  if (!selectedTrack) {
    return <div className="page"><div className="page-wrap subject-catalog-page">
      ...
      <WorkbookInspiration specialization="ai-engineering" materialId={subjects[0]?.next?.id} compact />
