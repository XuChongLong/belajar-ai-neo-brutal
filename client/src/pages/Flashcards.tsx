...
export default function Flashcards() {
  ...
  const allCards = useMemo(() => {
    ...
    const activeWrongQuestions = Object.fromEntries(Object.entries(wrongQuizQuestions).map(([key, questions]) => [key, questions.filter((question) => activeMaterialIds.has(question.materialId))]));
    return buildFlashcards(glossaryTerms, activeWrongQuestions);
  }, [wrongQuizQuestions]);
