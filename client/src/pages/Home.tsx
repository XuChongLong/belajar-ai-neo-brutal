...
export default function Home() {
  ...
  return <div className="page home-page">
    <div className="page-wrap">
      ...
      <section className="home-tools"><Link href="/review" className="home-tool home-tool-pink"><RotateCcw size={22} /><div><span className="eyebrow">ULANGI DENGAN CERDAS</span><h3>Mode Review</h3><p>Temukan konsep yang perlu dikuatkan dan langkah berikutnya.</p></div><ArrowRight size={17} /></Link><Link href="/glosarium" className="home-tool home-tool-yellow"><BookMarked size={22} /><div><span className="eyebrow">MARGIN NOTES</span><h3>Glosarium AI</h3><p>{bookmarkCount ? `${bookmarkCount} materi tersimpan · ` : ""}Cari istilah dengan bahasa yang lebih ramah.</p></div><ArrowRight size={17} /></Link></section>
