...
export const learningGoals: LearningGoal[] = [
  ...
  { id: "ai-safety-builder", label: "AI Safety Builder", emoji: "◆", description: "Bangun kebiasaan keamanan dan safety sejak awal.", priorities: ["Cyber Security", "AI Agents & Tools", "Dasar-Dasar AI", "Large Language Models"], keywords: ["Security", "Secret", "Prompt Injection", "Akses", "Agent"] },
