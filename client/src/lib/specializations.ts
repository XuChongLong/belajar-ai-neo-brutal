...
export const specializationMeta: Record<SpecializationId, SpecializationMeta> = {
  "ai-engineering": { id: "ai-engineering", label: "AI Engineering", shortLabel: "AI Engineering", emoji: "✦", accent: "pink", intro: "Bawa ide dari satu prompt dan demo kecil menuju sistem AI yang dapat diuji, dipantau, dan dipercaya." },
